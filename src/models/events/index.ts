...
import { OrderCompletedV1Event } from "./order-completed-v1.event";
...
import { OrderPickedUpV1Event } from "./order-pickedup-v1.event";
...
export type OrderEvent =
  ...
  | OrderPickedUpV1Event
  | OrderCompletedV1Event;
